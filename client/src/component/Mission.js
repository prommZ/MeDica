...
class Mission extends Component {
    ...
    render() { 
        return ( 
            ...
            The Mission of MeDica Hospital is to provide compassionate, accessible, high quality, 
            ...
            <br/>
            <p className = "text-white container">
            MeDica Hospital will be an innovative, leading regional health system dedicated to advancing the 
